...
out_xlsx = f"{outpath}Galileo_accuracy_with2025.xlsx"
out_cmat = f"{outpath}Galileo_confmat_with2025.png"
out_f1sc = f"{outpath}Galileo_f1score_with2025.png"
...
eyear = 2025
season = "B"
raster_path1 = f"{root}outputs/{district1}_{season}{eyear}_merged_labels_with2025.tif"
raster_path2 = f"{root}outputs/{district2}_{season}{eyear}_merged_labels_with2025.tif"
raster_path3 = f"{root}outputs/{district3}_{season}{eyear}_merged_labels_with2025.tif"
raster_path4 = f"{root}outputs/{district4}_{season}{eyear}_merged_labels_with2025.tif"
vector_path = f"{root}shapefiles/RWA_{season}{eyear}_Merge_v1_ValidSet.shp"       # RWA_B2025_Merge_v1_ValidSet
N_WORKERS = os.cpu_count() - 56
...
'''
raster_paths = [
    f"{root}outputs/{d}_{season}{eyear}_merged_labels_with2025.tif"
